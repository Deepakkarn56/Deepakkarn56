...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=2EAD33&center=true&vCenter=true&width=600&lines=🎭+Automating+tests+with+Playwright...;⚡+Load+testing+with+Apache+JMeter...;🔗+API+testing+with+Postman...;🤖+Learning+AI-powered+QA+strategies...)](https://git.io/typing-svg)
...
| About Me | Currently Learning |
|---|---|
| 🔍 QA Automation engineer | 🤖 Playwright + AI integration |
| 🎭 Working with **Playwright** | 🔧 Self-healing locators |
| 🤖 Interested in AI-driven testing | 📦 CI/CD with GitHub Actions |
| 💻 Frontend background (React, JS) | 👁️ Visual regression testing |
| 📬 karndeepakk@gmail.com | |
...
![Codegen CLI](https://img.shields.io/badge/Codegen_CLI-0ea5e9?style=flat-square)
![Page Object Model](https://img.shields.io/badge/Page_Object_Model-64748b?style=flat-square)
![Visual Regression](https://img.shields.io/badge/Visual_Regression-e11d48?style=flat-square)
...
| Status | Goal |
|--------|------|
| ✅ Done | Postman — API testing |
| ✅ Done | Apache JMeter — load testing |
| ✅ Done | Playwright — core concepts |
